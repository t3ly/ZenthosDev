                                ...
                                if (currentCombo == null || currentCombo.equals("reset")) {
                                        ...
                                        if (guess != null) {
                                                if (combo == guess) {
                                                        ...
                                                        var black = Packages.server.life.MapleLifeFactory.getMonster(9300036);
                                                        var myst = Packages.server.life.MapleLifeFactory.getMonster(9300037);
                                                        if (attempt < 7) {
                                                                ...
                                                                for (var i = 0; i < 5; i++) {
                                                                        ...
                                                                        black = Packages.server.life.MapleLifeFactory.getMonster(9300036);
                                                                        myst = Packages.server.life.MapleLifeFactory.getMonster(9300037);
