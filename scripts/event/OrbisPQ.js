...
function playerEntry(eim, player) {
	...
	player.getClient().getSession().write(Packages.tools.MaplePacketCreator.getNPCTalk(2013001, /*(byte)*/ 0, texttt, "00 00"));
	//player.getClient().getSession().write(Packages.scripting.npc.NPCScriptManager.dispose(eim.getClient()));
	//THE CLOCK IS SHIT
