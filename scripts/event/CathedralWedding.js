...
function playerEntry(eim, player) {
	...
	//player.getClient().getSession().write(Packages.tools.MaplePacketCreator.getClock(1200));
	//player.getClient().getSession().write(Packages.tools.MaplePacketCreator.getClock(180));
...
function playerWarpAltar(eim, player) {
	...
	player.getClient().getSession().write(Packages.tools.MaplePacketCreator.getClock(300));
	player.getClient().getSession().write(Packages.tools.MaplePacketCreator.serverNotice(6, "Please talk to High Priest John now!"));
	}
}
